...
local default_opts = require("gitb_nvim.defaults")
local M = {}
local api = vim.api
...
function M.blameVirtText()
	...
	local key = utils.cache_key(currFile, line)
...
function M.setup(opts)
	...
	-- Highlights
	utils.set_highlight("GitBlameAuthor", M.opts.highlights.author)
	utils.set_highlight("GitBlameDate", M.opts.highlights.date)
	utils.set_highlight("GitBlameMsg", M.opts.highlights.msg)
